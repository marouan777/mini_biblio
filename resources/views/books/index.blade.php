    ...
    <table class="w-full mt-3 border text-sm">
        ...
        <tbody>
            ...
            <tr class="border-t hover:bg-gray-50">
                ...
                <td class="p-2 btn btn-success">{{ $book->status ?? '—' }}</td>
                <td class="p-2">
